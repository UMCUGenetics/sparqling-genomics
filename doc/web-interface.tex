...
%  parameters to be wrapped in \texttt{<parameters>...</parameters>}.

%  So, to log in using an XML request, use:
%\begin{siderules}
%\begin{verbatim}
...
%  Subsequently, when accepting \texttt{application/xml} the results are wrapped
%  in \texttt{<results>...</results>}, and data structures built from multiple
%  key-value pairs are wrapped in \texttt{<result>...<result>}.  The following
%  example illustrates how that looks.
