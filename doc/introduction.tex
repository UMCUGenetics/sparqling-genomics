...
\label{sec:obtaining-tarball}
  ...
  page.  Make sure to download the \mbox{\texttt{sparqling-genomics-0.99.6.tar.gz}}
  file.
  \end{sloppypar}
...
download/0.99.6/sparqling-genomics-0.99.6.tar.gz
\end{verbatim}
\end{siderules}
...
\begin{siderules}
\begin{verbatim}
tar zxvf sparqling-genomics-0.99.6.tar.gz
cd sparqling-genomics-0.99.6
\end{verbatim}
\end{siderules}
