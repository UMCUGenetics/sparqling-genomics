...
\label{sec:prerequisites}
  ...
  \begin{table}[H]
    \begin{tabularx}{\textwidth}{X *{9}{l}}
      ...
      \evenrow
      \texttt{table2rdf}  & $\bullet{}$ & $\bullet{}$ & $\bullet{}$ &             &             & $\bullet{}$ &             &             &\\
      \oddrow
      \texttt{json2rdf}   & $\bullet{}$ & $\bullet{}$ & $\bullet{}$ &             &             & $\bullet{}$ &             &             &\\
      \evenrow
      \texttt{xml2rdf}    & $\bullet{}$ & $\bullet{}$ & $\bullet{}$ & $\bullet{}$ &             & $\bullet{}$ &             &             &\\
      \oddrow
